 <body>
    ...
    <div style="margin-top: 50px; padding: 0px 80px;">
        <h2><b>Event Manager Dashboard</b></h2>
    </div>
    <div class="full-width-bar-sub">
        ...
        <div class="content-box-test" onclick="window.location.href='personSearch.php'">
            <div class="icon-overlay">
                <img style="border-radius: 5px;" src="images/person-search.svg" alt="Calendar Icon">
            </div>

            <div class="large-text-sub">Search Users</div>
            <div class="graph-text">Find a certain user.</div>
            <button class="arrow-button">→</button>
        </div>
