...
/* Board documents (board-level clearance, 3 most recent) */
$boardDocsPreview = [];
$_dbconn = connect();
$_bdResult = mysqli_query($_dbconn, "SELECT doc_name, file_path, uploaded_at FROM boarddocuments WHERE deleted = 0 AND clearance_level IN ('volunteer', 'board_member') ORDER BY uploaded_at DESC LIMIT 3");
...
$volType             = ucfirst(str_replace('_', ' ', $person->get_type() ?: 'Board Member'));
?>
