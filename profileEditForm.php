...
<main class="signup-form">
    ...
    <p>
        ...
        <?php if ($editingSelf): ?>
            <button class="button cancel" href="viewProfile.php" style="margin-top: -.5rem">Cancel</a>
        <?php else: ?>
            <button class="button cancel" href="viewProfile.php?id=<?php echo htmlspecialchars($_GET['id']) ?>" style="margin-top: -.5rem">Cancel</a>
        <?php endif ?>
    </form>
    </div>
    <script>
