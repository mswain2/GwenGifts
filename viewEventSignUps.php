...
// Resolve pending signups via available function name(s) without directly invoking unknown functions
$pending_signups = [];
if (is_callable('fetch_pending_signups')) {
    ...
    // fallback if the function is named differently in another file
...
<head>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (bulkApprove) bulkApprove.addEventListener('click', function(e) {
                e.preventDefault();
                handleBulk('approve');
            });
            if (bulkReject) bulkReject.addEventListener('click', function(e) {
                e.preventDefault();
                handleBulk('reject');
            });
        });
            ...
            <table class="general">
                ...
                <tbody>
                    <?php foreach ($signups as $signup):
                        ...
                        $shirt_size = $user_info && $user_info->get_t_shirt_size()
                            ? $user_info->get_t_shirt_size()
                            : 'N/A';
                    ?>
                        <tr>
                            <?php if ($access_level >= 2): ?>
                            ...
                            <td><?php echo htmlspecialchars($first_name ?: 'Unknown'); ?></td>
                            <td><?php echo htmlspecialchars($last_name ?: 'Unknown'); ?></td>
                            <td><?php echo htmlspecialchars($email ?: 'N/A'); ?></td>
                            ...
                            <td><?php 
                                ...
                                echo $formatted_notes; ?></td>
                            <td><?php if ($pending == '0') echo "Yes";
                                elseif ($pending == '1') echo "No"; ?></td>
